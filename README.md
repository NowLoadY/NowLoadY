...
I’m currently working on a RC-car, in my imagination, it should have some amazing way to be controlled, I can't stop thinking how it would be if I use my Samsung Galaxy Watch to control it! And its control program seems to be wrote in dart, which is the main language of flutter. I'm also writing RC-car's program, which includes "dealing with sensors signal", "control motor in a correct speed"  
